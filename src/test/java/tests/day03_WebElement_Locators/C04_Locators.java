...
public class C04_Locators {
    public static void main(String[] args) throws InterruptedException {
        ...
        //arama kutusunun yanındaki todays deals linkini tıklayın
        ...
        atama yapmadan locate ve click islemini aynı satırda yapabiliriz.
        ancak daha sonra bakanlar icin anlasılır olmayabilir.
         */
        // WebElement todaysDealsElementi = driver.findElement(By.linkText("Today's Deals"));
        ...
        //acılan sayfada ilk urune tıklayın
